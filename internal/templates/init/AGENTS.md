...
1. Read `.doug/plan/ACTIVE_STEP.md` for the current planning step when it exists.
2. Read `docs/kb/README.md` for the knowledge base index when project-specific implementation context is needed.
3. Read only the documents relevant to the active planning step.
